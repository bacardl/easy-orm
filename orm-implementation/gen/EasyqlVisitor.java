...
public interface EasyqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link EasyqlParser#value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValue(EasyqlParser.ValueContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link EasyqlParser#equalpair}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqualpair(EasyqlParser.EqualpairContext ctx);
	/**
