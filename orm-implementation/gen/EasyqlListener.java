...
public interface EasyqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EasyqlParser#value}.
	 * @param ctx the parse tree
	 */
	void enterValue(EasyqlParser.ValueContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyqlParser#value}.
	 * @param ctx the parse tree
	 */
	void exitValue(EasyqlParser.ValueContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link EasyqlParser#equalpair}.
	 * @param ctx the parse tree
	 */
	void enterEqualpair(EasyqlParser.EqualpairContext ctx);
	/**
	 * Exit a parse tree produced by {@link EasyqlParser#equalpair}.
	 * @param ctx the parse tree
	 */
	void exitEqualpair(EasyqlParser.EqualpairContext ctx);
	/**
